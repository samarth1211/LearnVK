...
::cl /c /EHsc Source.cpp /I "%VULKAN_SDK%\Include" /D "_UNICODE" /D "UNICODE" /D "DEBUG" /D "_DEBUG" /Fo:"SwapChains.obj"
cl /c /EHsc Source.cpp /I "%VULKAN_SDK%\Include" /Fo:"SwapChains.obj"
