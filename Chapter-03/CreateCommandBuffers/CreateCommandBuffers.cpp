...
// VkCommandBuffer g_vlkCommandBuffer[QUEUE_MAX_COUNT] = {VK_NULL_HANDLE, VK_NULL_HANDLE};
...
int main(int argc, char **argv, char **envp)
{
    ...
    */
    ...
    /*for (size_t i = 0; i < QUEUE_MAX_COUNT; i++)
    {
        std::cout << "g_vlkCommandBuffer[" << i << "] = " << g_vlkCommandBuffer[i] << std::endl;
    }*/
